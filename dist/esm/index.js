...
var WidgetTest = function (_a) {
    ...
    var onMessage = useCallback(function (_a) {
    ...
    return (React.createElement("iframe", { title: "wordkito-widget-test", style: __assign({ border: "none", width: "100%", height: "500px" }, iframeStyle), src: fullUrl }));
};
